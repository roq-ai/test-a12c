...
import { getHabitById } from 'apiSdk/habits';
import { HabitInterface } from 'interfaces/habit';

function HabitViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('habit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/habits/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Habit Name" text={data?.habit_name} />

                <FormListItem label="Training Program" text={data?.training_program} />
